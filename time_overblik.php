...
// Check if time registration module is enabled
if (!$modules['tidsregistrering']) {
    echo '<!DOCTYPE html><html lang="da"><head><meta charset="UTF-8"><title>Tidsregistrering - Deaktiveret</title>';
    echo '<link rel="stylesheet" href="style.css"></head><body>';
    echo '<div class="container" style="padding:40px 20px; text-align:center;">';
    echo '<h2>Tidsregistrering er midlertidigt deaktiveret</h2>';
